...
public class FonctionProgram
{
    ...
    // ══════════════════════════════════════════════════════════
    public static void GestionJoueurs(out int nbJoueurs, out string[] nomsJoueurs, out int[] scoresJoueurs)
    {
        int i = 0;     // compteur pour parcourir les joueurs
        nbJoueurs = 0;
        nomsJoueurs = new string[0];
        scoresJoueurs = new int[0];

        LireEntier("Combien de joueurs ? (1 à 4) :", out nbJoueurs);
        ...
        while (i < nbJoueurs)
        {
            LireChaine("Nom du joueur " + (i + 1) + " :", out nomsJoueurs[i]);
            scoresJoueurs[i] = 0;
            i = i + 1;
        }
    }
